...
func execute_code(
	code: String, execute_context: Dictionary = {}, editor_plugin = null
) -> Dictionary:
	var result = {
...
func _execute_snippet(
	instance: RefCounted, execute_context: ExecutionContext, result: Dictionary
) -> void:
