...
func test_default_args_dictionary() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/container_build_in_types/ClassWithDictionaryDefaultArguments.gd"
	)
		...
		. is_equal(
			(
				...
				. create(
					...
					TYPE_ARRAY,
					[
						GdFunctionArgument.new(
							"dict", TYPE_DICTIONARY, {"a": "value_a", "b": "value_b"}
						),
					]
				)
			)
...
func test_default_args_array() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/container_build_in_types/ClassWithArrayDefaultArguments.gd"
	)
...
func test_default_args_callable() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/container_build_in_types/ClassWithCallableDefaultArguments.gd"
	)
...
func test_default_args_variant() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/ClassWithVariantTypeDefaultArguments.gd"
	)
		...
		. is_equal(
			(
				...
				. create(
					...
					[
						GdFunctionArgument.new(
							"ucids", TYPE_ARRAY, GdFunctionArgument.UNDEFINED, TYPE_INT
						),
...
func test_default_args_basic_type_int() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeIntDefaultArguments.gd"
	)
...
func test_default_args_basic_type_float() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeFloatDefaultArguments.gd"
	)
...
func test_default_args_basic_type_bool() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeBoolDefaultArguments.gd"
	)
...
func test_default_args_basic_type_string() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeStringDefaultArguments.gd"
	)
...
func test_default_args_basic_type_string_name() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeStringNameDefaultArguments.gd"
	)
...
func test_default_args_basic_type_node_path() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeNodePathDefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector2() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector2DefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector2i() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector2iDefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector3() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector3DefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector3i() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector3iDefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector4() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector4DefaultArguments.gd"
	)
...
func test_default_args_basic_type_vector4i() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeVector4iDefaultArguments.gd"
	)
...
func test_default_args_basic_type_rect2() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeRect2DefaultArguments.gd"
	)
		...
		. is_equal(
			(
				...
				. create(
					...
					[
						GdFunctionArgument.new(
							"value", TYPE_RECT2, Rect2(Vector2.ONE, Vector2.ZERO)
						),
					]
				)
			)
		...
		. is_equal(
			(
				...
				. create(
					...
					[
						GdFunctionArgument.new(
							"value", TYPE_RECT2, Rect2(Vector2(0, 1), Vector2(2, 3))
						),
					]
				)
			)
...
func test_default_args_basic_type_transform2d() -> void:
	var script: GDScript = load(
		"res://addons/gdUnit4/test/core/resources/parsing/functions/basic_build_in_types/ClassWithBasicTypeTransform2DDefaultArguments.gd"
	)
	...
	(
		...
		. is_equal(
			(
				GdFunctionDescriptor
				. create(
					"on_transform2d_case4",
					script.resource_path,
					17,
					TYPE_TRANSFORM2D,
					[
						GdFunctionArgument.new(
							"value", TYPE_TRANSFORM2D, Transform2D(1.2, Vector2.ONE)
						),
					]
				)
			)
