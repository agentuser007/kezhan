...
@onready var ExampleClassWithPushNotifications := preload(
	"res://addons/gdUnit4/test/core/execution/resources/error_monitoring/ExampleClassWithPushNotifications.gd"
)
