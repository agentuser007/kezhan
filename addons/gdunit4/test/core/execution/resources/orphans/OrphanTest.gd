...
func test_with_scene_orphans() -> void:
	...
	var runner := scene_runner(
		"res://addons/gdUnit4/test/core/execution/resources/orphans/OrphanScene.tscn"
	)
...
func test_load_scene_orphans() -> void:
	# run scene with orphan nodes
	var _scene: Node2D = (
		preload("res://addons/gdUnit4/test/core/execution/resources/orphans/OrphanScene.tscn")
		. instantiate()
	)
	@warning_ignore("redundant_await")
	collect_orphan_node_details()
