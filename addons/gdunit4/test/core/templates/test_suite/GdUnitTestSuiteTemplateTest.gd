...
func test_default_template() -> void:
	(
		assert_str(GdUnitTestSuiteTemplate.default_template(GdUnitTestSuiteTemplate.TEMPLATE_ID_GD))
		. is_equal(GdUnitTestSuiteTemplate.default_GD_template())
	)


func test_build_template_default() -> void:
	var template := GdUnitTestSuiteTemplate.build_template(
		"res://addons/gdUnit4/test/core/resources/script_with_class_name.gd"
	)
	var expected := (
		"""
		# GdUnit generated TestSuite
...
func test_build_template_custom2() -> void:
	GdUnitTestSuiteTemplate.save_template(GdUnitTestSuiteTemplate.TEMPLATE_ID_GD, CUSTOM_TEMPLATE)
	var template := GdUnitTestSuiteTemplate.build_template(
		"res://addons/gdUnit4/test/core/resources/script_without_class_name.gd"
	)
	var expected := (
		"""
		# GdUnit generated TestSuite
