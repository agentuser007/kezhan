...
func before_test() -> void:
	ProjectSettings.set_setting(
		GdUnitSettings.TEST_SUITE_NAMING_CONVENTION, GdUnitSettings.NAMING_CONVENTIONS.AUTO_DETECT
	)
	clean_temp_dir()
...
func test_resolve_test_suite_path_project() -> void:
	...
	assert_str(resolve_path("res://project_name/module/foo.gd")).is_equal(
		"res://_test_/project_name/module/foo_test.gd"
	)
	# otherwise build relative to 'src'
	assert_str(resolve_path("res://src/foo.gd")).is_equal("res://_test_/foo_test.gd")
	assert_str(resolve_path("res://project_name/src/foo.gd")).is_equal(
		"res://project_name/_test_/foo_test.gd"
	)
	assert_str(resolve_path("res://project_name/src/module/foo.gd")).is_equal(
		"res://project_name/_test_/module/foo_test.gd"
	)


func test_resolve_test_suite_path_plugins() -> void:
	assert_str(resolve_path("res://addons/plugin_a/foo.gd")).is_equal(
		"res://addons/plugin_a/_test_/foo_test.gd"
	)
	assert_str(resolve_path("res://addons/plugin_a/src/foo.gd")).is_equal(
		"res://addons/plugin_a/_test_/foo_test.gd"
	)
...
func test_resolve_test_suite_path__no_test_root() -> void:
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/src/models/events/ModelChangedEvent.gd", ""
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/MyPlugin/src/models/events/ModelChangedEvent.gd", ""
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"user://project/src/models/events/ModelChangedEvent.gd", ""
			)
		)
...
func test_resolve_test_suite_path__path_contains_src_folder() -> void:
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/src/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/MyPlugin/src/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"user://project/src/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
...
func test_resolve_test_suite_path__path_not_contains_src_folder() -> void:
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/models/events/ModelChangedEvent.gd"
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/MyPlugin/models/events/ModelChangedEvent.gd"
			)
		)
		. is_equal("res://addons/MyPlugin/test/models/events/ModelChangedEventTest.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/MyPlugin/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
		. is_equal("res://addons/MyPlugin/custom_test/models/events/ModelChangedEventTest.gd")
	)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"user://project/models/events/ModelChangedEvent.gd"
			)
		)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"user://project/models/events/ModelChangedEvent.gd", "custom_test"
			)
		)
...
func test_create_test_suite_pascal_case_path() -> void:
	...
	assert_file(result.value()).exists().is_file().is_script().contains_exactly(
		[
			"# GdUnit generated TestSuite",
...
func test_create_test_case() -> void:
	...
	assert_file(info.get("path")).exists().is_file().is_script().contains_exactly(
		[
			"# GdUnit generated TestSuite",
...
func test_build_test_suite_path() -> void:
	...
	assert_str(GdUnitTestSuiteScanner.resolve_test_suite_path("res://new_script.gd")).is_equal(
		"res://test/new_script_test.gd"
	)

	# checked project without src folder
	(
		assert_str(GdUnitTestSuiteScanner.resolve_test_suite_path("res://foo/bar/new_script.gd"))
		. is_equal("res://test/foo/bar/new_script_test.gd")
	)

	# project code structured by 'src'
	assert_str(GdUnitTestSuiteScanner.resolve_test_suite_path("res://src/new_script.gd")).is_equal(
		"res://test/new_script_test.gd"
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path("res://src/foo/bar/new_script.gd")
		)
		. is_equal("res://test/foo/bar/new_script_test.gd")
	)
	# folder name contains 'src' in name
	(
		assert_str(GdUnitTestSuiteScanner.resolve_test_suite_path("res://foo/srcare/new_script.gd"))
		. is_equal("res://test/foo/srcare/new_script_test.gd")
	)
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/plugin/foo/bar/new_script.gd"
			)
		)
		. is_equal("res://addons/plugin/test/foo/bar/new_script_test.gd")
	)
	# plugin code structured by 'src'
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://addons/plugin/src/foo/bar/new_script.gd"
			)
		)
		. is_equal("res://addons/plugin/test/foo/bar/new_script_test.gd")
	)
	...
	assert_str(GdUnitTestSuiteScanner.resolve_test_suite_path(source_path)).is_equal(
		"user://tmp/test/projectX/entity/PersonTest.gd"
	)


func test_scan_by_inheritance_class_name() -> void:
	var scanner: GdUnitTestSuiteScanner = GdUnitTestSuiteScanner.new()
	var test_suites := scanner.scan(
		"res://addons/gdUnit4/test/core/resources/scan_testsuite_inheritance/by_class_name/"
	)

	assert_array(test_suites).has_size(3)
	# sort by names
	(
		assert_array(test_suites)
		. extract("resource_path")
...
func test_get_test_case_line_number() -> void:
	(
		assert_int(
			GdUnitTestSuiteScanner.get_test_case_line_number(
				"res://addons/gdUnit4/test/core/GdUnitTestSuiteScannerTest.gd",
	...
	(
		assert_int(
			GdUnitTestSuiteScanner.get_test_case_line_number(
				"res://addons/gdUnit4/test/core/GdUnitTestSuiteScannerTest.gd", "unknown"
			)
		)
		. is_equal(-1)
	)
...
func test__to_naming_convention() -> void:
	...
	ProjectSettings.set_setting(
		GdUnitSettings.TEST_SUITE_NAMING_CONVENTION, GdUnitSettings.NAMING_CONVENTIONS.SNAKE_CASE
	)
	...
	ProjectSettings.set_setting(
		GdUnitSettings.TEST_SUITE_NAMING_CONVENTION, GdUnitSettings.NAMING_CONVENTIONS.PASCAL_CASE
	)
	assert_str(GdUnitTestSuiteScanner._to_naming_convention("MyClass")).is_equal("MyClassTest")
...
func test_resolve_test_suite_path() -> void:
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/src/folder/myclass.gd", "test"
			)
		)
		. is_equal("res://project/test/folder/myclass_test.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
		...
		. is_equal("res://project/test/folder/MyClassTest.gd")
	)
	# forcing to use source directory to create the test
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/src/folder/myclass.gd", ""
			)
		)
		. is_equal("res://project/src/folder/myclass_test.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
		...
		. is_equal("res://project/src/folder/MyClassTest.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
...
func test_resolve_test_suite_path_with_src_folders() -> void:
	...
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
				"res://project/folder/myclass.gd", "test"
			)
		)
		. is_equal("res://test/project/folder/myclass_test.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path(
		...
		. is_equal("res://test/project/folder/MyClassTest.gd")
	)
	# forcing to use source directory to create the test
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path("res://project/folder/myclass.gd", "")
		)
		. is_equal("res://project/folder/myclass_test.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path("res://project/folder/MyClass.gd", "")
		)
		. is_equal("res://project/folder/MyClassTest.gd")
	)
	(
		assert_str(
			GdUnitTestSuiteScanner.resolve_test_suite_path("res://project/folder/myclass.gd", "/")
...
func test_scan_test_suite_exclude_non_test_suites() -> void:
	var scanner: GdUnitTestSuiteScanner = GdUnitTestSuiteScanner.new()
	var test_suites := scanner.scan(
		"res://addons/gdUnit4/test/core/resources/scan_testsuite_inheritance/plugin/"
	)
