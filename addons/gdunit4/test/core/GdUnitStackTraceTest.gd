...
func test_captures_stack_depth_0() -> void:
	...
	(
		...
		. is_equal(
			"\tat 'test_captures_stack_depth_0' in res://addons/gdUnit4/test/core/GdUnitStackTraceTest.gd:39\n"
		)
	)
		...
		. has_stack_trace(
			[
				GdUnitStackTraceElement.new(
					"res://addons/gdUnit4/test/core/GdUnitStackTraceTest.gd", 109, "verify_call"
				),
				GdUnitStackTraceElement.new(
					"res://addons/gdUnit4/test/core/GdUnitStackTraceTest.gd",
					107,
					"test_mock_frames_are_filtered_from_stack_trace"
				),
			]
		)
	)
...
func test_spy_frames_are_filtered_from_stack_trace() -> void:
	...
	(
		...
		. has_stack_trace(
			[
				GdUnitStackTraceElement.new(
					"res://addons/gdUnit4/test/core/GdUnitStackTraceTest.gd", 122, "verify_call"
				),
				GdUnitStackTraceElement.new(
					"res://addons/gdUnit4/test/core/GdUnitStackTraceTest.gd",
					120,
					"test_spy_frames_are_filtered_from_stack_trace"
				),
			]
		)
	)
...
func test_serialize_returns_json_string() -> void:
	...
	(
		...
		. is_not_empty()
		. is_equal(
			'[{"function":"func_a","line":10,"source":"res://test.gd"},{"function":"func_b","line":20,"source":"res://test.gd"}]'
		)
	)
