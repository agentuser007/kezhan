...
const GdUnitInspectorProgressBar := preload(
	"res://addons/gdUnit4/src/ui/parts/GdUnitInspectorProgressBar.gd"
)
...
func before_test() -> void:
	...
	_progress = (
		load("res://addons/gdUnit4/src/ui/parts/GdUnitInspectorProgressBar.tscn").instantiate()
	)
	add_child(_progress)
...
func test_progress_on_test_counter_changed(
	index: int,
	total_count: int,
	state: GdUnitInspectorTreeConstants.STATE,
