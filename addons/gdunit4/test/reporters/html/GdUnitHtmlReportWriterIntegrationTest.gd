...
func test_write_report() -> void:
	...
	_assert_report_matches(_report_dir + "/index.html", RESOURCE_REPORTS + "report_1/index.html")
	...
	_assert_report_matches(
		...
		(
			RESOURCE_REPORTS
			+ "report_1/test_suites/%s.TestSuiteAllStagesSuccess.html" % suite_report_path
		)
	)
	_assert_report_matches(
		...
		(
			RESOURCE_REPORTS
			+ "report_1/test_suites/%s.TestSuiteFailOnMultipeStages.html" % suite_report_path
		)
	)
	_assert_report_matches(
