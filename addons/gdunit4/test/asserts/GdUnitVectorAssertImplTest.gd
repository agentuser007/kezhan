...
func test_supported_types(value: Variant, test_parameters := _test_seta) -> void:
	assert_object(assert_vector(value)).is_not_null().is_instanceof(GdUnitVectorAssert)


@warning_ignore("unused_parameter")
func test_unsupported_types(
	value: Variant,
	details: String,
	test_parameters := [
		[true, "bool"],
...
func test_is_equal() -> void:
	...
	(
		...
		. is_failed()
		. has_message(
			"Expecting:\n '$v0'\n but was\n '<null>'".replace("$v0", str(Vector2(1.2, 1.000001)))
		)
	)
...
func test_is_not_equal() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000001)).is_not_equal(Vector2(1.2, 1.000001))
		)
		. is_failed()
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000001)).is_not_equal(Vector3(1.2, 1.000001, 1.0))
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
func test_is_equal_approx() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_vector(current).is_equal_approx(Vector2.ONE, Vector2(0, 0.004))
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void: assert_vector(null).is_equal_approx(Vector2.ONE, Vector2(0, 0.004))
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000001)).is_equal_approx(
					Vector3.ONE, Vector3(1.2, 1.000001, 1.0)
				)
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(0.878431, 0.505882)).is_equal_approx(
					Vector2(0.878431, 0.105882), Vector2(0.000001, 0.000001)
				)
		)
		. is_failed()
		. has_message(
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(currentV3).is_equal_approx(
					Vector3(0.0, 0.878431, 0.105882), Vector3(0.000001, 0.000001, 0.000001)
				)
		)
		. is_failed()
		. has_message(
...
@warning_ignore("unused_parameter")
func test_is_equal_approx_over_all_types(
	value: Variant,
	expected: Variant,
	approx: Variant,
	test_parameters := [
...
func test_is_less() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2(1.2, 1.000001)).is_less(Vector2(1.2, 1.000001))
		)
		. is_failed()
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000001)).is_less(Vector3(1.2, 1.000001, 1.0))
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
@warning_ignore("unused_parameter")
func test_is_less_over_all_types(
	value: Variant,
	expected: Variant,
	test_parameters := [
...
func test_is_less_equal() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000002)).is_less_equal(Vector2(1.2, 1.000001))
		)
		. is_failed()
		. has_message(
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000002)).is_less_equal(Vector3(1.2, 1.000001, 1.0))
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
@warning_ignore("unused_parameter")
func test_is_less_equal_over_all_types(
	value: Variant,
	expected: Variant,
	test_parameters := [
		[Vector2(1.0, 1.0), Vector2(1.0001, 1.0001)],
...
func test_is_greater() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2(1.2, 1.000001)).is_greater(Vector2(1.2, 1.000001))
		)
		. is_failed()
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000001)).is_greater(Vector3(1.2, 1.000001, 1.0))
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
@warning_ignore("unused_parameter")
func test_is_greater_over_all_types(
	value: Variant,
	expected: Variant,
	test_parameters := [
...
func test_is_greater_equal() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000002)).is_greater_equal(Vector2(1.2, 1.000003))
		)
		. is_failed()
		. has_message(
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1.2, 1.000002)).is_greater_equal(Vector3(1.2, 1.000003, 1.0))
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
@warning_ignore("unused_parameter")
func test_is_greater_equal_over_all_types(
	value: Variant,
	expected: Variant,
	test_parameters := [
		[Vector2(1.0001, 1.0001), Vector2(1.0, 1.0)],
...
func test_is_between(
	fuzzer := Fuzzers.rangev2(Vector2.ZERO, Vector2.ONE), fuzzer_iterations := 200
) -> void:
...
@warning_ignore("unused_parameter")
func test_is_not_between(
	fuzzer := Fuzzers.rangev2(Vector2.ONE, Vector2.ONE * 2), fuzzer_iterations := 200
) -> void:
	var value: Vector2 = fuzzer.next_value()
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2.ONE).is_not_between(Vector2.ZERO, Vector2.ONE)
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2.ONE).is_not_between(Vector3.ZERO, Vector2.ONE)
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
...
@warning_ignore("unused_parameter")
func test_is_not_between_over_all_types(
	value: Variant,
	from: Variant,
	to: Variant,
	test_parameters := [
...
func test_override_failure_message() -> void:
	assert_object(assert_vector(Vector2.ONE).override_failure_message("error")).is_instanceof(
		GdUnitVectorAssert
	)
...
func test_append_failure_message() -> void:
	assert_object(assert_vector(Vector2.ONE).append_failure_message("error")).is_instanceof(
		GdUnitVectorAssert
	)
	@warning_ignore("unsafe_method_access")
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2.ONE).append_failure_message("custom failure data").is_equal(
					Vector2.ZERO
				)
		)
		. is_failed()
...
func test_is_failure() -> void:
	...
	assert_failure(func() -> void: assert_vector(RefCounted.new()).is_null()).is_failed()
