...
func test_override_failure_message() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_int(314).override_failure_message("Custom failure message").is_null()
		)
		. is_failed()
...
func test_append_failure_message() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_int(314).append_failure_message("custom failure data").is_zero()
		)
		. is_failed()
		. has_message(
			(
...
func test_is_failure() -> void:
	...
	assert_failure(func() -> void: assert_int(1).is_zero()).is_failed()
