...
func test_has_line() -> void:
	assert_failure(func() -> void: assert_bool(true).is_false()).is_failed().has_line(16)


func test_has_message() -> void:
	assert_failure(func() -> void: assert_bool(true).is_true()).is_success()
	(
