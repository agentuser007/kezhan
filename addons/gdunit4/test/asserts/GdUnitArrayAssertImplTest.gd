...
func test_is_equal() -> void:
	...
	assert_failure(func() -> void: assert_array([1, 2, 3, 4, 5]).is_equal([1, 2, 3, 4])).is_failed()
...
func test_is_equal_ignoring_case() -> void:
	assert_array(["this", "is", "a", "message"]).is_equal_ignoring_case(
		["This", "is", "a", "Message"]
	)
...
func test_is_not_equal_ignoring_case() -> void:
	...
	assert_array(["this", "is", "a", "message"]).is_not_equal_ignoring_case(
		["This", "is", "an", "Message"]
	)
...
func test_contains() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_array([valueA, valueB]).contains([TestObj.new("C", 0)])
		)
		. is_failed()
		. has_message(
			(
...
func test_contains_exactly() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_array([1, 2, 3, 4, 5]).contains_exactly([1, 4, 3, 2, 5])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void: assert_array([1, 2, 3, 4, 5, 6, 7]).contains_exactly([1, 4, 3, 2, 5])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void: assert_array([1, 2, 3, 4, 5]).contains_exactly([1, 4, 3, 2, 5, 6, 7])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void:
				assert_array([valueA, valueB]).contains_exactly([valueB, TestObj.new("A", 0)])
		)
		. is_failed()
		. has_message(
			(
...
func test_contains_exactly_in_any_order() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_array([1, 2, 6, 4, 5]).contains_exactly_in_any_order([5, 3, 2, 4, 1, 9, 10])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void:
				assert_array([1, 2, 6, 9, 10, 4, 5]).contains_exactly_in_any_order([5, 3, 2, 4, 1])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void:
				assert_array([valueA, valueB]).contains_exactly_in_any_order(
					[valueB, TestObj.new("C", 0)]
				)
		)
		. is_failed()
		. has_message(
...
func test_contains_same() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_array([valueA, valueB]).contains_same([TestObj.new("A", 0)])
		)
		. is_failed()
		. has_message(
			(
...
func test_contains_same_exactly() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_array([valueA, valueB]).contains_same_exactly([valueB, valueA])
		)
		. is_failed()
		. has_message(
			(
	...
	(
		assert_failure(
			func() -> void:
				assert_array([valueA, valueB]).contains_same_exactly([TestObj.new("A", 0), valueB])
		)
		. is_failed()
		. has_message(
			(
...
func test_contains_same_exactly_in_any_order() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_array([valueA, valueB]).contains_same_exactly_in_any_order(
					[valueB, TestObj.new("A", 0)]
				)
		)
		. is_failed()
		. has_message(
...
func test_not_contains() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_array([valueA, valueB]).not_contains([TestObj.new("A", 0)])
		)
		. is_failed()
		. has_message(
			(
...
func test_fluent() -> void:
	assert_array([]).has_size(0).is_empty().is_not_null().contains([]).contains_exactly([])
...
func test_extract() -> void:
	...
	assert_array([1, false, 3.14, null, Color.ALICE_BLUE]).extract("get_class").contains_exactly(
		"n.a.", "n.a.", "n.a.", null, "n.a."
	)
	# extracting by a func without arguments
	(
		assert_array([RefCounted.new(), 2, AStar3D.new(), auto_free(Node.new())])
		. extract("get_class")
	...
	(
		assert_failure(
			func() -> void:
				assert_array(null).extract("get_class").contains_exactly("AStar3D", "Node")
		)
		. is_failed()
		. has_message(
			(
...
func test_extractv() -> void:
	...
	(
		assert_array(
			[TestObj.new("A", 10), TestObj.new("B", "foo"), Color.ALICE_BLUE, TestObj.new("C", 11)]
		)
	...
	(
		assert_array(
			[TestObj.new("A", 10), TestObj.new("B", "foo", "bar"), TestObj.new("C", 11, 42)]
		)
...
func test_override_failure_message() -> void:
	assert_object(assert_array([]).override_failure_message("error")).is_instanceof(
		GdUnitArrayAssert
	)
	(
		assert_failure(
			func() -> void:
				assert_array([]).override_failure_message("Custom failure message").is_null()
		)
		. is_failed()
...
func test_append_failure_message() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_array([]).append_failure_message("custom failure data").is_not_empty()
		)
		. is_failed()
		. has_message(
			(
...
func test_is_failure() -> void:
	...
	assert_failure(func() -> void: assert_array([]).is_not_empty()).is_failed()
...
func test_contains_exactly_stuck() -> void:
	var example_a := ExampleTestClass.new().add_child(ExampleTestClass.new()).add_child(
		ExampleTestClass.new()
	)
	var example_b := ExampleTestClass.new().add_child(ExampleTestClass.new()).add_child(
		ExampleTestClass.new()
	)
	...
	(
		assert_failure(
			func() -> void:
				assert_array([example_a, example_b]).contains_exactly(
					example_a, example_b, example_a
				)
		)
		. is_failed()
	)
